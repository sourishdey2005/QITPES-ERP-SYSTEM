          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 cursor-pointer group">
              <div className="flex flex-col items-end mr-1">
                ...
                <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wider">{userRole}</span>
              </div>
              <div className="w-9 h-9 bg-blue-50 rounded-lg flex items-center justify-center overflow-hidden border border-blue-100 group-hover:border-blue-300 transition-all">
