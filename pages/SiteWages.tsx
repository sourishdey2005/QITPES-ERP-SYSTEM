  ...
  return (
    <div className="space-y-8 page-transition text-black">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex bg-white p-1.5 rounded-[24px] border border-slate-200 shadow-xl">
                              ...
                              <div className="flex gap-2">
                                 <button 
                                   ...
                                   className={`flex-1 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${
                                     status === 'Present' ? 'bg-emerald-600 text-white shadow-xl shadow-emerald-500/20' : 'bg-white text-slate-400 hover:bg-slate-100'
                                   }`}
                                 >
                                    Present
                                 </button>
                                 <button 
                                   ...
                                   className={`flex-1 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all ${
                                     status === 'Absent' ? 'bg-rose-600 text-white shadow-xl shadow-rose-500/20' : 'bg-white text-slate-400 hover:bg-slate-100'
                                   }`}
                                 >
                                    Absent
                                 </button>
