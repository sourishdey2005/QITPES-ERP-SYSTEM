      ...
      <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
         <div className="p-6 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between">
            <h3 className="font-bold text-slate-800 flex items-center gap-2">
              <Activity size={18} className="text-blue-500" /> Operational Unit Registry
            </h3>
         </div>
                  ...
                  <tr key={v.id} className="hover:bg-slate-50/50 group transition-all">
                     ...
                     <td className="px-8 py-5 text-right">
                        <button 
                          ...
                          className="flex items-center gap-2 ml-auto px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-xl hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all font-bold text-xs"
                        >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} className="bg-white rounded-[32px] shadow-2xl w-full max-w-lg overflow-hidden border border-slate-100">
              <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs font-bold text-blue-600 uppercase tracking-widest mt-0.5">{selectedVehicle.vehicle_number} Registry Update</p>
                </div>
              ...
              <div className="p-8 space-y-6">
                 <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                       ...
                       <select 
                         ...
                         className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none font-bold text-sm focus:ring-4 focus:ring-blue-500/5 transition-all"
                       >
                 ...
                 <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      className="w-full h-28 p-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none text-sm font-medium focus:ring-4 focus:ring-blue-500/5 transition-all"
                 ...
                 <div className="p-5 bg-blue-50/50 border border-blue-100 rounded-2xl flex items-start gap-3">
                    <ClipboardCheck className="text-blue-500 shrink-0 mt-0.5" size={18} />
                    <p className="text-[10px] text-blue-700 font-bold leading-relaxed uppercase">Enterprise Assurance: This update will trigger an audit trail entry in the Global Compliance Ledger.</p>
                 </div>
...
const StatCard = ({ label, value, icon, color }: any) => (
  <div className="bg-white p-6 rounded-[24px] border border-slate-200 shadow-sm flex items-center gap-4 hover:border-blue-200 transition-all cursor-default group">
    <div className={`p-4 rounded-2xl bg-${color}-50 text-${color}-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-500`}>{icon}</div>
    <div>
