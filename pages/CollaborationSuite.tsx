          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-md">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white rounded-[48px] shadow-2xl w-full max-w-xl overflow-hidden border border-slate-200">
              ...
              <form onSubmit={(e) => { e.preventDefault(); createMeeting.mutate({...bookingForm, organizer_id: 'internal'}); }} className="p-12 space-y-8">
                ...
                <button disabled={createMeeting.isPending || !bookingForm.room_id} type="submit" className="w-full py-6 bg-red-600 text-white rounded-[24px] font-black text-sm uppercase tracking-[0.3em] shadow-2xl shadow-red-500/40 hover:bg-red-700 transition-all flex items-center justify-center gap-4 disabled:opacity-50 disabled:cursor-not-allowed">
