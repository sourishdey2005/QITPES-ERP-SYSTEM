  ...
  return (
    <div className="space-y-6 page-transition max-w-4xl mx-auto">
      ...
      <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl">
         <div className="space-y-4">
            ...
            <textarea 
               ...
               className="w-full h-32 p-4 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-4 focus:ring-blue-500/10 transition-all text-slate-800"
            />
            <button 
               onClick={generateStrategy}
               disabled={loading}
               className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 disabled:bg-slate-300 transition-all shadow-lg"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <div className="p-4 bg-blue-50 text-blue-800 rounded-2xl border border-blue-100 flex items-center justify-between group cursor-pointer">
