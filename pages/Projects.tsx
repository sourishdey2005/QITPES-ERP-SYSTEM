...
import { Plus, Search, Filter, Calendar, MoreHorizontal, ChevronRight } from 'lucide-react';
    ...
    <div className="space-y-6 page-transition">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center justify-center px-4 py-2 bg-blue-600 text-black rounded-lg hover:bg-blue-500 font-bold shadow-lg shadow-blue-500/20 transition-all"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="p-6 flex-1">
                <div className="flex items-start justify-between mb-4">
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-blue-600 text-black">
                    {project.status}
                  </span>
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4">
                    <div className="flex items-center text-xs font-medium text-slate-500 bg-slate-50 px-2 py-1 rounded">
                      ...
                      <span>{project.start_date ? project.start_date : 'Jan 2026'}</span>
                    </div>
          ...
          {(!projects || projects.length === 0) && (
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="col-span-full py-20 text-center bg-white rounded-2xl border-2 border-dashed border-slate-200"
            >
